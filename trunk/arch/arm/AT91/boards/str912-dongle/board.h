...
/* =============================================================================
    ...
    Copyright (c) 2008 Psitek (Pty) Ltd [www.psitek.com]
    All rights reserved.

    The source code contained in this file is confidential, proprietary
    and a trade secret. Without prior written approval from Psitek
    ...
    All content is owned by Psitek. Other trademarks and copyright
